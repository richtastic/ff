...
self.do_drag_bar.addFunction(DO.EVENT_ADDED_TO_STAGE,self.addListenersDragBar);
	...
	// size handles
	self.do_drag_bar.graphicsIllustration.clearGraphics();
	self.do_drag_bar.graphicsIllustration.setFillRGBA(0x00FF0099);
	...
	self.do_stretch_left.graphicsIllustration.clearGraphics();
	self.do_stretch_left.graphicsIllustration.setFillRGBA(0xFF000099);
	...
	self.do_stretch_right.graphicsIllustration.clearGraphics();
	self.do_stretch_right.graphicsIllustration.setFillRGBA(0xFF000099);
	...
	self.do_stretch_top.graphicsIllustration.clearGraphics();
	self.do_stretch_top.graphicsIllustration.setFillRGBA(0xFF000099);
	...
	self.do_stretch_bot.graphicsIllustration.clearGraphics();
	self.do_stretch_bot.graphicsIllustration.setFillRGBA(0xFF000099);
	...
	self.do_stretch_tl.graphicsIllustration.clearGraphics();
	self.do_stretch_tl.graphicsIllustration.setFillRGBA(0xFFFF0099);
	...
	self.do_stretch_tr.graphicsIllustration.clearGraphics();
	self.do_stretch_tr.graphicsIllustration.setFillRGBA(0xFFFF0099);
	...
	self.do_stretch_bl.graphicsIllustration.clearGraphics();
	self.do_stretch_bl.graphicsIllustration.setFillRGBA(0xFFFF0099);
	...
	self.do_stretch_br.graphicsIllustration.clearGraphics();
	self.do_stretch_br.graphicsIllustration.setFillRGBA(0xFFFF0099);
