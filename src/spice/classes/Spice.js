...
*/
		...
		circuitElementList.push({icon: self.resource.tex[ResourceSpice.TEX_LIB_ITEM_ICON_GROUND], text:"GROUND", clas:DOResistor});
		...
		circuitElementList.push({icon: self.resource.tex[ResourceSpice.TEX_LIB_ITEM_ICON_BJT], text:"TRANSISTOR", clas:DOResistor});
		...
		circuitElementList.push({icon: self.resource.tex[ResourceSpice.TEX_LIB_ITEM_ICON_CHIP], text:"CHIP", clas:DOResistor});
		circuitElementList.push({icon: self.resource.tex[ResourceSpice.TEX_LIB_ITEM_ICON_TRANSFORMER], text:"TRANSFORMER", clas:DOResistor});
		circuitElementList.push({icon: self.resource.tex[ResourceSpice.TEX_LIB_ITEM_ICON_RESISTOR], text:"1234567890", clas:DOResistor});
