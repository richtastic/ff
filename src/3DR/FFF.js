...
FFF.prototype.handleKeyboardUp = function(e){
	//console.log(e);
}
FFF.prototype.handleKeyboardDownStill = function(e){
	this.handleKeyboardDown(e);
}
FFF.prototype.handleKeyboardDown = function(e){
...
FFF.prototype.segmentImageToServer = function(){
...
FFF.prototype.handleSceneImagesLoaded = function(imageInfo){
	console.log("loaded")
...
/*
FFF.prototype.applyFilter = function(type,value, r,g,b, wid,hei){
