...
console.log("averagePoints3DFromMatches");
...
++PROBE_CALL;
	// c.fromArray(log(" => PROBE3D REMOVING OLD MATCHES: "+badMatches.length); // a result of ?
	// console.log(" => PROBE3D ADDING NEW MATCHES: "+newMatches.length+" | "+PROBE_CALL);
/*
	// add matches
	var addedPoints = [];
