...
// console.log(".   ...   "+index);
		...
		for(var i=0; i<points2D.length; ++i){
			...
			for(var j=i+1; j<points2D.length; ++j){
				...
				combine by score, eg:
					NCCA - 0.20 => 0.57
					NCCB - 0.15 => 0.42 <- better score: reverse 
					(0.20 + 0.15)
					
					(1/.15 + 1/.20)
					1/.15 => (1/.15)/(1/.15 + 1/.20) = 0.57
					1/.20 => (1/.20)/(1/.15 + 1/.20) = 0.42
...
Stereopsis.World.prototype.filterGlobalMatches = function(relax){ // drops matches from transform (pairwise discarding)
	...
	// var limitMatchSigmaNCC = 1.5;
	// var limitMatchSigmaSAD = 1.5;
	if(relax){
