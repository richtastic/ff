...
function ImageFeature(x,y, wid,hei, origR,origG,origB,origY, gradRX,gradRY, gradGX,gradGY, gradBX,gradBY, gradYX,gradYY){
	this._bitmap = new ColorMatRGBY(wid,hei, origR,origG,origB,origY, x,y, ImageFeature.SQUARE_SIZE_SELECT,ImageFeature.SQUARE_SIZE_SELECT); // NxN bitmap of original point
