...
function Test(){
	...
	self.setupMatrices = function(){
		...
		//self.doA0.matrix.scale(2.0);
		//self.doA0.matrix.rotate(Math.PI*0.125);
		//self.doA0.matrix.translate(0.0,50.0);
	...
	this.stageEnterFrameFxn = function(e){
		self.doA.matrix.identity();
		self.doA.matrix.translate(150,150); // 2
		self.doA.matrix.rotate(Math.PI*self.curr*0.1); // 1
		self.doA.matrix.translate(50,0); // 0
		//self.doA0.matrix.identity();
		//self.doA0.matrix.scale(2.0);
		//self.doA0.matrix.translate(0.0,25.0);
		//self.doA0.matrix.rotate(self.curr*0.2);
		//self.doA0.matrix.translate(0.0,-25.0);
		//self.doA0.matrix.translate(0.0,25.0);
		self.curr++;
	}
